...
<h2>Directory/File tree to JSON</h2>
...
<a href="https://badge.fury.io/js/@yetanothertool%2Fdirectory-scanner"><img src="https://badge.fury.io/js/@yetanothertool%2Fdirectory-scanner.svg" alt="npm version" height="18"></a>

---

## About

Simple NodeJS script to scan the current directory and extract the tree into a `hierarchy.json` file.
...
Then open the `hierarchy.json` to see your file/directory tree.
